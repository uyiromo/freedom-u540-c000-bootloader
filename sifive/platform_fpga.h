...
#define MEMORY_MEM_SIZE _AC(0x40000000,UL)  /* kernal can use only 1-GiB */
//#define MEMORY_MEM_SIZE _AC(0x100000000,UL) /* kernel can use all  4-GiB */
